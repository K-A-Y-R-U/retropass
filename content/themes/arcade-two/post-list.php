...
<div class="container">
	<div class="post-container">
		<div class="content-wrapper">
			<h3 class="page-title"><i class="bi bi-clock-history b-icon"></i><?php _e('Latest posts') ?></h3>
							...
							<div class="post-media">
								...
								<div class="post-body">
									...
									<div class="post-intro">
										<?php echo mb_strimwidth(strip_tags($post->content), 0, 180, "...") ?>
									</div>
									<div class="mt-3"></div>
									<a href="<?php echo get_permalink('post', $post->slug) ?>">
										<div class="btn btn-capsule"><?php _e('Read More') ?></div>
									</a>
								</div>
							</div>
						</div>
