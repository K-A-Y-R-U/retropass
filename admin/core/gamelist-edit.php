                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="3" id="description-editor" required><?php echo $game->description ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="instructions"><?php _e('Instructions') ?>:</label>
                            <textarea class="form-control" name="instructions" rows="3" id="instructions-editor"><?php echo $game->instructions ?></textarea>
                        </div>
                        <div class="mb-3">
