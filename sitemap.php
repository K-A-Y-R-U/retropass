...
// Generar sitemap-pl.xml
$sitemap_pl = '<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';

// Aquí puedes añadir las URLs específicas para sitemap-pl.xml si es necesario
$sitemap_pl .= '<url>
    <loc>'.DOMAIN.'path/to/specific/page</loc>
    <changefreq>daily</changefreq>
    <priority>0.9</priority>
</url>';

// Añadir otras URLs desde tu base de datos o configuración
$sitemap_pl .= '</urlset>';

file_put_contents(dirname(__FILE__).'/sitemap-pl.xml', $sitemap_pl);
